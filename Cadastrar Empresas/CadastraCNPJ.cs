...
namespace Vanilla
{
    public partial class CadastraCNPJ : Form
    {
        ...
        private void GravarCnpj()
        {
            ...
            cad.GravarCnpj(util.FormataCnpj(textcnpj.Text), nomefantasia.Text, textname.Text, Convert.ToDateTime(textdataatual.Text), Convert.ToDateTime(textabertura.Text), textie.Text, combotypeemp.Text, textel.Text, textemail.Text, combostatus.Text, textlogradouro.Text, Convert.ToInt32(textnumber.Text), textcompl.Text, textbairro.Text, textmuni.Text, combouf.Text, textcep.Text);
            editar = false;
            Cursor = Cursors.Default;
            Clear();
        }
        ...
        {
            cad.EditarCnpj(id, util.FormataCnpj(textcnpj.Text), nomefantasia.Text, textname.Text, Convert.ToDateTime(textdataatual.Text), Convert.ToDateTime(textabertura.Text), textie.Text, combotypeemp.Text, textel.Text, textemail.Text, combostatus.Text, textlogradouro.Text, Convert.ToInt32(textnumber.Text), textcompl.Text, textbairro.Text, textmuni.Text, combouf.Text, textcep.Text);
            editar = false;
            Clear();
