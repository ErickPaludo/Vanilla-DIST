...
namespace Vanilla
{
    public class CadastraCnpjBack : Endereco
    {
        ...
        public void EditarCnpj(int id,string cnpj, string nomefantasia, string nome, DateTime abertura, DateTime cadastro, string insc_est, string type_cad, string tel, string email, string status, string rua, int numero, string comple, string bairro, string cidade, string uf, string cep)//Grava a empresa via banco
        {
            db.EditarTFC(id,nomefantasia, nome, cnpj, abertura, cadastro, insc_est, type_cad, tel, email, status, rua, numero, comple, bairro, cidade, uf, cep);
