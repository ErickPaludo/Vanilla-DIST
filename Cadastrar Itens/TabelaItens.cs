...
namespace Vanilla
{
    ...
    public partial class TabelaItens : Form
    {
      ...
      .ToList();
        ...
        public void AddNaTabelaItens(int id, int id_forn, string nome_fantasia, string codbar, string item, string descricao, string unmed, int quantidade, decimal preco_custo, decimal lucro_porcent, decimal preco_final, string status)
        {
            itens.Add(new CadastrarItens(id, id_forn, nome_fantasia, item, preco_custo, lucro_porcent, preco_final, quantidade, codbar, status, descricao, unmed));
        }
